...
<style>
  ...
  :global([data-theme="light"]) .title-line.accent .char {
  ...
  :global([data-theme="light"]) .rotating-text {
    background: linear-gradient(90deg, #1a365d, #0891b2);
    -webkit-background-clip: text;
    background-clip: text;
  }

  :global([data-theme="light"]) .industry-badges {
    border-top: 1px solid rgba(26, 54, 93, 0.1);
    border-bottom: 1px solid rgba(26, 54, 93, 0.1);
  }

  :global([data-theme="light"]) .industry-item {
    background: rgba(26, 54, 93, 0.05);
    border: 1px solid rgba(26, 54, 93, 0.15);
  }

  :global([data-theme="light"]) .scroll-line {
    background: rgba(26, 54, 93, 0.2);
  }

  :global([data-theme="light"]) .hero-badge {
    background: linear-gradient(135deg, rgba(26, 54, 93, 0.12), rgba(26, 54, 93, 0.06));
  ...
  :global([data-theme="light"]) .static-text {
    color: #1e3a5f;
  }

  :global([data-theme="light"]) .badges-label {
    color: #1e3a5f;
  }
  ...
  :global([data-theme="light"]) .stat-plus {
    color: #0891b2;
  }

  :global([data-theme="light"]) .scroll-indicator span {
    color: #1e3a5f;
  }
</style>
